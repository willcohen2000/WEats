...
public class ModernSearchBarCell: UITableViewCell {
    ...
    private func setup(){
        ...
        self.labelModelSearchBar.textColor = blueColor;
        self.labelModelSearchBar.font = UIFont(name: "Lato-Regular", size: 18);
    ...
    public func configureConstraints(heightImage: CGFloat, widthImage: CGFloat){
        ...
        let leftImageConstraint = NSLayoutConstraint(item: self.imgModernSearchBar, attribute:.left, relatedBy: .equal, toItem: self.contentView, attribute: .left, multiplier: 1.0, constant:  5) //EDDDDIt
        ...
        let leftLabelConstraint = NSLayoutConstraint(item: self.labelModelSearchBar, attribute:.left, relatedBy: .equal, toItem: self.imgModernSearchBar, attribute: .right, multiplier: 1.0, constant:  5) // EDDIT here
        ...
        let rightLabelConstraint = NSLayoutConstraint(item: self.labelModelSearchBar, attribute:.right, relatedBy: .equal, toItem: self.contentView, attribute: .right, multiplier: 1.0, constant:  5)
